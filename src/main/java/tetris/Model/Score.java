...
public class Score {
    ...
    public void processoNivel(){
        if(linhasApagadas <= 50)
            nivel = linhasApagadas / 10 + 1;
        else if (linhasApagadas <= 70)
            nivel = 7;
        else if (linhasApagadas <= 100)
            nivel = 8;
        else if (linhasApagadas <= 140)
            nivel = 9;
        else if (linhasApagadas <= 190)
            nivel = 10;
        else
            nivel = 11 + (linhasApagadas-190)/50;
    }
