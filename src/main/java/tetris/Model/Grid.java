...
public class Grid {
    ...
    public Grid(int comprimento, int altura, int x, int y, int tamanhoBloco){
        ...
        this.x = x;
        this.y = y;
        this.matriz=creatematriz(comprimento,altura);
    }

    public List<List<String>> creatematriz(int comprimento, int altura){
        matriz = new Vector<>();
    ...
    public Grid(Peca piece, int x, int y, int tamanhoBloco){
        ...
        this.x = x;
        this.y = y;
        this.matriz=creatematrizPiece(piece,comprimento,comprimento);
    }

    public List<List<String>> creatematrizPiece(Peca piece, int comprimento, int altura){
        matriz = new Vector<>();
        for (int i = 0; i < altura; i++){
            List <String> linhas = new Vector<>();
            for(int j = 0; j < comprimento; j++){
